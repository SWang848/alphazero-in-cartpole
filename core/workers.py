...
class MCTSWorker:
    def __init__(
        ...
        self.envs = [config.env_creator(simulator=False, num_target_blocks=config.num_target_blocks, diff_reward=config.diff_reward, mask_location=config.mask_location) for _ in range(self.num_envs)]
