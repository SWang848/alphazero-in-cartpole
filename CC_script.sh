...
PYTHONUNBUFFERED=1 python3 -u main.py --wandb --amp --cc --group_name c56b_longer --seed 0 \
                ...
                --training_steps 70 --c_init $1 --value_support_min -50 --value_support_max 0 --value_support_delta 1 --diff_reward --mask_location
...
#                 --training_steps 35 --c_init $1 --value_support_min -50 --value_support_max 0 --value_support_delta 1--diff_reward --mask_location
...
#                 --training_steps 25 --c_init $1 --value_support_min -50 --value_support_max 0 --value_support_delta 1 --diff_reward --mask_location
...
#                 --training_steps 25 --c_init 1.25 --value_support_min -50 --value_support_max 0 --value_support_delta 1 -- diff_reward --mask_location
