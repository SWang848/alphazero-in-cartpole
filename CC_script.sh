...
PYTHONUNBUFFERED=1 python3 -u main.py --cc --wandb --group_name c15b_gumbel_RL4RS --amp --env Classic-v0 --seed 0 --num_rollout_workers 10 --num_cpus_per_worker 1.2 --num_envs_per_worker 20 --num_gpus_per_worker 0.1 --min_num_episodes_per_worker 20 --num_target_blocks 15 --place_order $1 --num_simulations 100 --max_training_time 28800 --c_init 2 --lr 5e-4 --value_support_min -1 --value_support_max 0 --value_support_delta 0.1 --m_top 8 --c_visit 36 --c_scale 1
