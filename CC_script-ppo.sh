...
export sub_dir="$1_$((RANDOM % 10000))"
PYTHONUNBUFFERED=1 python3 -u ppo_main.py --wandb --cc --group_name c15b_ppo_RL4RS --env Classic-v0 --seed 0 --num_target_blocks 15 --num_envs 10 --lr_a 5e-4 --lr_c 5e-4 --entropy_coef 1e-4 --max_training_time 28800 --rollout_size 512 --mini_batch_size 128 --place_order $1
